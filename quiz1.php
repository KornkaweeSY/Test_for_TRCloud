            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="flex gap-4">
                        <input type="number" id="test_triangle" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
...
<script>
    document.getElementById('btn_test_triangle').addEventListener('click', function() {
        ...
        if (input_triangle >= 0) {
            ...
            document.getElementById('result_triangle').innerHTML = 'Please enter a positive number.';
        }
    });
